...
const DropdownIcon = ({ className }) => (
    <img src="/dropdown.svg" alt="" className={className} style={{ width: '0.75rem', height: '0.75rem' }} />
);
...
const Dropdown = ({
    ...
    const displayText = formatDisplay ? formatDisplay(selected) : (selected?.label || placeholder);
    ...
    if (disabled) {
        return (
            <div className={`flex items-center gap-[0.375rem] text-[0.75rem] text-gray-600 ${className}`}>
