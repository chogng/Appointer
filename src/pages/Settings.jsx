...
import { User, Moon, Sun, Monitor, Lock, Camera, Check } from 'lucide-react';
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex gap-2 mb-2">
                                <input
                                    ...
                                    className="flex-1 px-3 py-1.5 bg-bg-page border border-border-subtle rounded-lg text-text-primary text-sm focus:outline-none focus:ring-1 focus:ring-accent"
                                />
                                <button
                                    type="button"
                            ...
                            <div className="flex flex-col gap-1">
                                <p className="text-xs text-text-secondary font-medium uppercase tracking-wider">{t(user?.role)}</p>
                                <label className="text-sm text-accent hover:text-accent-focus cursor-pointer font-medium inline-block w-fit">
                                    {t('changeAvatar')}
                                    <input type="file" className="hidden" accept="image/*" onChange={handleAvatarChange} />
                                </label>
                            </div>
